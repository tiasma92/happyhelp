...
render(){
  ...
  <Marker
          ...
          style={{  width: 100, height: 100, alignItems:'center', borderWidth: 1, borderColor:'grey', borderRadius: 7 }}/>
            ...
            <Button title="J'aide" fontSize="30" buttonStyle={{ backgroundColor:"#2C5F13", alignItems:'center', justifyContent: 'center', height:12}}onPress= {() => this.props.navigation.navigate("HomeA")} />
          </View>
        </Callout></Marker>)
  return(
