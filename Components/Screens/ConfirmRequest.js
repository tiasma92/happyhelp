...
{ this.state.fontLoaded? (
   <View style={{textAlign: 'center', alignContent:'center'}}>
    ...
    <Button title="VALIDER"  onPress={()=>this.props.navigation.navigate('confirmD')} buttonStyle={{borderRadius: 13, backgroundColor:"#2C5F13", alignItems:'center', textAlign:'center', justifyContent: 'center'}}/>
    </View>
</View> 
